            ...
            var table = $('#kt_datatable').DataTable({
                ...
                columns: [
                    ...
                    { "data": "note" },
                    {
                        ...
                        "data": function (deger) {
                            html = '\
                            <a href="student_profile?id={0}" class="btn btn-sm btn-default btn-text-primary btn-hover-primary btn-icon mr-2" title="Öğrenci Profili">\
                    ...
                    },
                    {
                        ...
                        "data": function (deger) {
                            html = '\
                            <a href="student_add?id={0}" class="btn btn-sm btn-default btn-text-primary btn-hover-primary btn-icon mr-2" title="Öğrenci Düzenle"> \
                                <span class="svg-icon svg-icon-md">\
