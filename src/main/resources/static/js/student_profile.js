        ...
        .then(function () {
            ...
            $('#testShow').click(function () {
                ...
                if (itemvalue == "MOXO Test") {
                    ...
                    $.ajax({
                        url: "/teststudent/tests/" + itemkey + "/student/" + urlStudentRef + "/filter",
                        method: "GET",
                    })
                        .done(function (data, textStatus, jqXHR) {
                            teststd = data;
                                ...
                                columns: [
                                    ...
                                    { "data": "result" },
                                    {
                                        ...
                                        "data": function (teststd) {
                                            html = '\
                                            <a href="test_profile?id={0}&ref={1}&ts={2}" class="btn btn-sm btn-default btn-text-primary btn-hover-primary btn-icon mr-2" title="Öğrenci Düzenle"> \
